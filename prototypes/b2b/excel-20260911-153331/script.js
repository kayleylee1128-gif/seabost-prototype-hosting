...
const wholesaleValues=[{seq:1,platform:'Amazon',store:'全部店铺',sku_qty:50,order_total_qty:100,auto_purchase:'是',shortage_rate:'20%',status:'启用',logs:[
  ...
  {operator:'林晓',action:'编辑',time:'2026-09-04 09:48:17',detail:'自动申购由否调整为是'},
  {operator:'林晓',action:'新增',time:'2026-09-02 14:35:20',detail:'创建批发单定义案例数据'}
]}];
